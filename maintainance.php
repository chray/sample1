...
<table style="margin:4px 4px 4px 4px;width:800px;height:50px;">
	...
	<tr>
		...
		<form method="post" action="maintainance.php">
...
<table style="margin:4px 4px 4px 4px;width:800px;height:50px;">
	...
	?>
		<td style="text-align:center;font-size:18px;"><input type="text" id="ppaval"readonly="true" name="ppa"style="margin-left:5px;width:250px;">
		<button style="margin-left:5px;" onclick="return showPPA()"class="g-button blue">...</button></td>
...
<table class="data-table">
	...
	<tr>
		...
		<a href="edit1.php?id=<?php echo $data['id'];?>" class="g-button green" onclick="return confirm('Edit?');"><i class="icon-pencil"></i></a >
		<a href="delete1.php?id=<?php echo $data['id'];?>"class="g-button red" onclick="return confirm('Delete?');"><i class="icon-remove"></i></a></td>
	</tr>
	<?php } ?>
</table>
			</div>	
