...
<button style="margin-left:10px;"class="g-button red" name="buttoncancel" onclick="return confirm('Are you sure you want to cancel?')">Cancel</button>
<table style="margin:4px 4px 4px 4px;width:800px;height:50px;">
	<tr>
	...
	?>
		<td style="text-align:center;font-size:18px;"><input type="text" readonly="true" id="ppaval" name="ppa"style="margin-left:5px;width:250px;"><button style="margin-left:5px;" onclick="return showPPA()" class="g-button blue">...</button></td>
...
<table class="data-table">
	...
	<tr>
		...
		<a class="g-button green"href="edit.php?id=<?php echo $data['id']?>" onclick="return confirm('Edit');"><i class="icon-pencil"></i></a>
		<a class="g-button red" href="delete.php?id=<?php echo $data['id'];?>" onclick="return confirm('Delete?');"><i class="icon-remove"></i></a></td>
	</tr>
	<?php } ?>
</table>
			</div>	
