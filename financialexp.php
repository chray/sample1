...
<table style="margin:4px 4px 4px 4px;width:800px;height:50px;">
	...
	<tr>
		...
		<form method="post" action="financialexp.php">
...
<table class="data-table">
	...
	<tr>
		...
		<a href="edit2.php?id=<?php echo $data['id'];?>" onclick="return confirm('Edit?');"class="g-button green"><i class="icon-pencil"></i></a>
		<a href="delete2.php?id=<?php echo $data['id'];?>" class="g-button red" onclick="return confirm('Delete?');"><i class="icon-remove"></i></a></td>
	</tr>
	<?php } ?>
</table>
			</div>	
